...
checkSwitcherState=function() {
    ...
    function() {
		var feedata = document.getElementById('feedata').innerHTML;
		alert(feedata);
        $('[data-id="switchery-state-text"]').text($(this).prop("checked") ? "document.getElementById('DIV1')" : "average (0.0002 btc)")
    }
    )
}
,
