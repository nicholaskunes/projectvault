...
renderSwitcher=function() {
    0!==$("[data-render=switchery]").length&&$("[data-render=switchery]").each(function() {
        ...
        if($(this).attr("data-theme"))switch($(this).attr("data-theme")) {
            ...
            case"blue": t=blue;
            break;
            case"purple": t=purple;
            break;
            case"orange": t=orange;
            break;
            case"black": t=black
        }
        var a= {};
        a.color=t,
        a.secondaryColor=$(this).attr("data-secondary-color")?$(this).attr("data-secondary-color"):"#dfdfdf",
        a.className=$(this).attr("data-classname")?$(this).attr("data-classname"):"switchery",
        a.disabled=$(this).attr("data-disabled")?!0:!1,
        a.disabledOpacity=$(this).attr("data-disabled-opacity")?parseFloat($(this).attr("data-disabled-opacity")):.5,
        a.speed=$(this).attr("data-speed")?$(this).attr("data-speed"):"0.5s";
        new Switchery(this,
        a)
    }
    )
...
checkSwitcherState=function() {
    ...
    $('[data-change="check-switchery-state-text"]').live("change",
    function() {
		var feedata = JSON.parse(document.getElementById('feedata').innerHTML);
        $('[data-id="switchery-state-text"]').text($(this).prop("checked") ? "priority (" + parseFloat(feedata.hourFee / 3).toPrecision(0) + " satoshi/byte)" : "average (" + parseFloat(feedata.hourFee / 4).toPrecision(0) + " satoshi/byte)")
    }
    )
}
,
